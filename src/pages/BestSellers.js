...
//       try {
//         const { data } = await axios.get(
//           `${process.env.REACT_APP_API_URL}/api/products/best-sellers`
//         );
//         setProducts(data);
//       } catch (err) {
...
//         <h2 className="text-2xl font-bold">Explore Our Top Products</h2>
  ...
  return (
    <section className="flex flex-col gap-4 items-center justify-center">
      <div className="flex flex-col gap-1 text-center">
        ...
        <p style={{textTransform: "uppercase"}}>Top products of the month</p>
      </div>
