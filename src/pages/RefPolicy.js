...
<p class="privacy-policy-tutorial">Buyers are responsible for return shipping cost. If the item is not returned in it's original condition, the buyer is responsible for any loss in value</p>
<p class="privacy-policy-tutorial">Cancelations is not accepted, please contact f_a36n@yahoo.com if you have any problem with your order</p>
<p class="privacy-policy-tutorial">Exchanges: The item must be returned no later than 14 days from the delivery date.</p>
</main>
