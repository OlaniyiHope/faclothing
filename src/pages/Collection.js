...
const Collection = () => {
  const [producttrend, setProductsTrend] = useState([]);
...
useEffect(() => {
  ...
  <Header />
    ...
    <main><div class="bg-slate-100"><div class="text-slate-900 bg-inherit"><div class="mx-auto max-w-[1440px] px-6"><nav class="pt-4" aria-label="Breadcrumb"><ol class="flex items-center"><li class="flex items-center"><a class="whitespace-nowrap text-rush-green-500
     ...
     </li><li class="truncate whitespace-nowrap text-slate-500">     </li></ol></nav></div></div></div><div class="bg-slate-100 text-slate-900 py-4"><div class="mx-auto max-w-[1440px] px-6"><div class="grid grid-cols-4 gap-8"><aside class="hidden h-fit flex-col divide-y rounded-2xl bg-white px-8 md:inline-flex">
...
<section className="py-8">
 ...
 {categories.map((cat) => (
  ...
  <div className="flex flex-col gap-1">
    <h3 className="text-3xl font-bold">Shop All Products</h3>
